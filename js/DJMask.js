...
DJMask={
			...
			alertMask:function(){//弹框遮罩
				var alertMaskHtml='<div id="dj-mask-alert" style="width:100%;height:100%;"></div>';								
			...
			alert:function(message,callback, title){//弹框提醒				
				...
				var alertDom='<div id="alertDom" class="dj-mask-alert-'+Math.floor(Math.random()*1000000)+'"></div>';
				$(alertDom).css({
					"width":"200px",
					"overflow":"hidden",
				...
				.append('<div style="height:30px;border-bottom:1px solid #ddd;line-height:30px;padding-left:10px;font-size:14px;color:#666;background:#ebebeb;text-align:center;">'+title+'<a style="float:right;margin-right:10px;cursor:pointer;color:#666;font-size:15px;" class="dj-alert-close">X</a></div>')
				.append('<div style="font-size:13px;color:#333;padding:10px;overflow:hidden;word-break:break-all;text-align:center;" class="dj-alert-content"></div>')
				.append('<a style="display:block;width:50px;height:25px;line-height:25px;text-align:center;border-radius:4px;background:#428bca;color:#fff;cursor:pointer;margin:0px auto;padding:0" class="dj-alert-ok">确定</a>');
